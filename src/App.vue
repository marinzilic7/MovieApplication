...
<template>
    ...
    <nav class="navbar navbar-expand-lg bgNav">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0 mobileBar">
            <li class="nav-item">
  ...
  <RouterView />
  <!-- Footer -->
  <footer class="text-center text-lg-start bg-white text-muted myFooter">
    <!-- Section: Social media -->
    <section
      class="d-flex justify-content-center justify-content-center p-4" 
    >
      <!-- Left -->
      <div class="me-5 d-none d-lg-block">
        <span> Marin Žilić</span>
      </div>
      <!-- Left -->
