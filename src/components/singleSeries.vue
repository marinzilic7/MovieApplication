        ...
        <div class="aboutMovie">
          ...
          <div class="detailsMovie">
            ...
            <div class="endDetails">
              <p>{{ getReleaseYear(singleMovie.first_air_date) }}</p>
              <div class="runTime">
                <p> Pogledano - {{ getFormattedVoteAverage(singleMovie.popularity) }} </p>
                <svg
  ...
  export default {
    ...
    methods: {
      getSingleMovie() {
        axios
          .get(
            `https://api.themoviedb.org/3/tv/${this.id}?api_key=2b24ba56d7cced960b52aa5d062f497e&language=en-US`
